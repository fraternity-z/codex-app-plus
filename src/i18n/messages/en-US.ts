...
export const enUS = {
  ...
  settings: {
    ...
    config: {
      ...
      proxy: {
        title: "Proxy",
        description: "Choose the proxy mode for Codex, host Git commands, and future embedded terminal sessions.",
        ...
        modeDescription: "Switch only between no proxy and the system proxy.",
        disabledOption: "No proxy",
        systemOption: "Use system proxy",
        disabledNote: "Proxy environment variables will be cleared.",
        systemOnNote: "System proxy settings will be read and written to HTTP_PROXY / HTTPS_PROXY / NO_PROXY.",
        customProxyDeferredNote: "Custom proxy is temporarily disabled: that path still has issues, so it will be redesigned later.",
