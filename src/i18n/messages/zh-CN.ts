...
export const zhCN = {
  ...
  settings: {
    ...
    config: {
      ...
      proxy: {
        title: "代理",
        description: "为 Codex、宿主 Git 与后续新建的内置终端会话选择代理模式。",
        ...
        modeLabel: "代理模式",
        modeDescription: "只在无代理和系统代理之间切换。",
        disabledOption: "不使用代理",
        systemOption: "使用系统代理",
        disabledNote: "当前会清理代理环境变量。",
        systemOnNote: "当前会读取系统代理，并写入 HTTP_PROXY / HTTPS_PROXY / NO_PROXY。",
        customProxyDeferredNote: "自定义代理暂时下线：这条路径还有点问题，后续再重新设计。",
        loading: "正在读取代理设置…",
        saveAction: "保存",
        saving: "保存中…",
