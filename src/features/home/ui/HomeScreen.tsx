  ...
  return (
    <>
      ...
      onRegenerateFromEditedUserMessage={actions.regenerateEditedUserMessage}
	      ...
	      onEditThreadGoal={conversation.editThreadGoal}
	      onToggleThreadGoalStatus={conversation.toggleThreadGoalStatus}
	      onClearThreadGoal={conversation.clearThreadGoal}
