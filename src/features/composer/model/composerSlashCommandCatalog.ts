...
const COMMANDS = Object.freeze<ReadonlyArray<ComposerSlashDefinition>>([
  ...
  { id: "goal", description: "设置或查看长任务目标。", flavor: "official", executionKind: "direct", action: null, aliases: [], availableDuringTask: true, supportsInlineArgs: true, visibilityGate: "goal" },
