...
use commands::{
    ...
    app_list_custom_pets, app_list_custom_prompts, app_list_managed_prompts,
    ...
    app_remember_command_approval_rule, app_reveal_path_in_folder, app_search_codex_sessions,
    app_server_restart, app_server_start, app_server_stop, app_set_agents_core,
    app_set_user_model_instructions_file, app_set_window_theme, app_show_context_menu,
    app_show_notification, app_start_window_dragging, app_transcribe_dictation_audio,
