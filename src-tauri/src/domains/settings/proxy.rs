...
pub fn read_proxy_settings(input: ReadProxySettingsInput) -> AppResult<ReadProxySettingsOutput> {
...
pub(crate) fn load_proxy_settings(agent_environment: AgentEnvironment) -> AppResult<ProxySettings> {
    let path = store_path()?;
...
#[cfg(test)]
mod tests {
    use super::ProxySettingsNormalization;
